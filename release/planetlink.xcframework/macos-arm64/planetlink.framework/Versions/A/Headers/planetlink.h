...
@class PlanetlinkCoreAccount, PlanetlinkCoreApplication, PlanetlinkCoreAttributedFiled, PlanetlinkCoreAttributedKind, PlanetlinkCoreAttributedString, PlanetlinkCoreAttributedStringCompanion, PlanetlinkCoreCapabilities, PlanetlinkCoreChannel, PlanetlinkCoreComment, PlanetlinkCoreCommentForm, PlanetlinkCoreContext, PlanetlinkCoreEmoji, PlanetlinkCoreEmojiCategoryType, PlanetlinkCoreEmojiCategoryTypeCompanion, PlanetlinkCoreEmojiCompanion, PlanetlinkCoreEmojiType, PlanetlinkCoreEmojiTypeCompanion, PlanetlinkCoreEmojiVariationType, PlanetlinkCoreEmojiVariationTypeCompanion, PlanetlinkCoreIdentify, PlanetlinkCoreLinkForm, PlanetlinkCoreMedia, PlanetlinkCoreMediaForm, PlanetlinkCoreMediaType, PlanetlinkCoreNotification, PlanetlinkCoreNotificationActionType, PlanetlinkCorePageable<T>, PlanetlinkCorePaging, PlanetlinkCorePollForm, PlanetlinkCoreProfileForm, PlanetlinkCoreRateLimit, PlanetlinkCoreRateLimitRateLimitValue, PlanetlinkCoreReaction, PlanetlinkCoreRelationship, PlanetlinkCoreSerializedRequest, PlanetlinkCoreSerializedRequestCompanion, PlanetlinkCoreService, PlanetlinkCoreSpace, PlanetlinkCoreThread, PlanetlinkCoreUser, PlanetlinkCoreUserActionImpl, PlanetlinkKotlinArray<T>, PlanetlinkKotlinByteArray, PlanetlinkKotlinByteIterator, PlanetlinkKotlinEnum<E>, PlanetlinkKotlinEnumCompanion, PlanetlinkKotlinException, PlanetlinkKotlinIllegalStateException, PlanetlinkKotlinInstant, PlanetlinkKotlinInstantCompanion, PlanetlinkKotlinIntIterator, PlanetlinkKotlinIntProgression, PlanetlinkKotlinIntProgressionCompanion, PlanetlinkKotlinIntRange, PlanetlinkKotlinIntRangeCompanion, PlanetlinkKotlinMatchGroup, PlanetlinkKotlinMatchResultDestructured, PlanetlinkKotlinNothing, PlanetlinkKotlinRegex, PlanetlinkKotlinRegexCompanion, PlanetlinkKotlinRegexOption, PlanetlinkKotlinRuntimeException, PlanetlinkKotlinThrowable, PlanetlinkKotlinx_serialization_coreSerialKind, PlanetlinkKotlinx_serialization_coreSerializersModule, PlanetlinkReference, PlanetlinkServiceEx;

@protocol PlanetlinkCoreAccountAction, PlanetlinkCoreActionType, PlanetlinkCoreAttributedElement, PlanetlinkCoreAttributedType, PlanetlinkCoreCommentAction, PlanetlinkCoreCommentUpdateStream, PlanetlinkCoreCommentsRequest, PlanetlinkCoreEventCallback, PlanetlinkCoreRequest, PlanetlinkCoreRequestAction, PlanetlinkCoreStream, PlanetlinkCoreUserAction, PlanetlinkCoreUsersRequest, PlanetlinkKotlinAnnotation, PlanetlinkKotlinClosedRange, PlanetlinkKotlinCollection, PlanetlinkKotlinComparable, PlanetlinkKotlinIterable, PlanetlinkKotlinIterator, PlanetlinkKotlinKAnnotatedElement, PlanetlinkKotlinKClass, PlanetlinkKotlinKClassifier, PlanetlinkKotlinKDeclarationContainer, PlanetlinkKotlinMatchGroupCollection, PlanetlinkKotlinMatchResult, PlanetlinkKotlinOpenEndRange, PlanetlinkKotlinSequence, PlanetlinkKotlinx_serialization_coreCompositeDecoder, PlanetlinkKotlinx_serialization_coreCompositeEncoder, PlanetlinkKotlinx_serialization_coreDecoder, PlanetlinkKotlinx_serialization_coreDeserializationStrategy, PlanetlinkKotlinx_serialization_coreEncoder, PlanetlinkKotlinx_serialization_coreKSerializer, PlanetlinkKotlinx_serialization_coreSerialDescriptor, PlanetlinkKotlinx_serialization_coreSerializationStrategy, PlanetlinkKotlinx_serialization_coreSerializersModuleCollector;
...
- (BOOL)isMatrix:(PlanetlinkCoreService *)receiver __attribute__((swift_name("isMatrix(_:)")));
- (BOOL)isNostr:(PlanetlinkCoreService *)receiver __attribute__((swift_name("isNostr(_:)")));
- (BOOL)isSaypip:(PlanetlinkCoreService *)receiver __attribute__((swift_name("isSaypip(_:)")));
 ...
 * Set rate limit info
 */
- (void)addInfoAction:(id<PlanetlinkCoreActionType>)action service:(NSString *)service limit:(int32_t)limit remaining:(int32_t)remaining reset:(PlanetlinkKotlinInstant *)reset __attribute__((swift_name("addInfo(action:service:limit:remaining:reset:)")));
...
*/
- (void)acceptFollowRequestId:(PlanetlinkCoreIdentify *)id completionHandler:(void (^)(NSError * _Nullable))completionHandler __attribute__((swift_name("acceptFollowRequest(id:completionHandler:)")));
 ...
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)addUserToListChannel:(PlanetlinkCoreIdentify *)channel user:(PlanetlinkCoreIdentify *)user completionHandler:(void (^)(NSError * _Nullable))completionHandler __attribute__((swift_name("addUserToList(channel:user:completionHandler:)")));
 ...
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)bookmarkCommentId:(PlanetlinkCoreIdentify *)id completionHandler:(void (^)(NSError * _Nullable))completionHandler __attribute__((swift_name("bookmarkComment(id:completionHandler:)")));

/**
 * Get Capabilities
 * このアダプターがサポートする機能一覧を取得
 */
- (PlanetlinkCoreCapabilities *)capabilities __attribute__((swift_name("capabilities()")));
 ...
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)createListName:(NSString *)name description:(NSString * _Nullable)description completionHandler:(void (^)(PlanetlinkCoreChannel * _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("createList(name:description:completionHandler:)")));
 ...
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)editCommentId:(PlanetlinkCoreIdentify *)id req:(PlanetlinkCoreCommentForm *)req completionHandler:(void (^)(NSError * _Nullable))completionHandler __attribute__((swift_name("editComment(id:req:completionHandler:)")));
 ...
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)markNotificationsReadUpToId:(PlanetlinkCoreIdentify * _Nullable)upToId completionHandler:(void (^)(NSError * _Nullable))completionHandler __attribute__((swift_name("markNotificationsRead(upToId:completionHandler:)")));
 ...
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)notificationPaging:(PlanetlinkCorePaging *)paging actions:(PlanetlinkKotlinArray<PlanetlinkCoreNotificationActionType *> * _Nullable)actions completionHandler:(void (^)(PlanetlinkCorePageable<PlanetlinkCoreNotification *> * _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("notification(paging:actions:completionHandler:)")));
 ...
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)rejectFollowRequestId:(PlanetlinkCoreIdentify *)id completionHandler:(void (^)(NSError * _Nullable))completionHandler __attribute__((swift_name("rejectFollowRequest(id:completionHandler:)")));
 ...
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)removeUserFromListChannel:(PlanetlinkCoreIdentify *)channel user:(PlanetlinkCoreIdentify *)user completionHandler:(void (^)(NSError * _Nullable))completionHandler __attribute__((swift_name("removeUserFromList(channel:user:completionHandler:)")));
 ...
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)reportCommentId:(PlanetlinkCoreIdentify *)id comment:(NSString * _Nullable)comment completionHandler:(void (^)(NSError * _Nullable))completionHandler __attribute__((swift_name("reportComment(id:comment:completionHandler:)")));
 ...
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)reportUserId:(PlanetlinkCoreIdentify *)id comment:(NSString * _Nullable)comment completionHandler:(void (^)(NSError * _Nullable))completionHandler __attribute__((swift_name("reportUser(id:comment:completionHandler:)")));
 ...
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)setCommentUpdateStreamComments:(NSArray<PlanetlinkCoreComment *> *)comments callback:(id<PlanetlinkCoreEventCallback>)callback completionHandler:(void (^)(id<PlanetlinkCoreCommentUpdateStream> _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("setCommentUpdateStream(comments:callback:completionHandler:)")));
 ...
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)spacesPaging:(PlanetlinkCorePaging *)paging completionHandler:(void (^)(PlanetlinkCorePageable<PlanetlinkCoreSpace *> * _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("spaces(paging:completionHandler:)")));
 ...
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)unbookmarkCommentId:(PlanetlinkCoreIdentify *)id completionHandler:(void (^)(NSError * _Nullable))completionHandler __attribute__((swift_name("unbookmarkComment(id:completionHandler:)")));
 ...
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)updateProfileForm:(PlanetlinkCoreProfileForm *)form completionHandler:(void (^)(NSError * _Nullable))completionHandler __attribute__((swift_name("updateProfile(form:completionHandler:)")));
 ...
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)userBookmarkTimeLinePaging:(PlanetlinkCorePaging *)paging completionHandler:(void (^)(PlanetlinkCorePageable<PlanetlinkCoreComment *> * _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("userBookmarkTimeLine(paging:completionHandler:)")));
 ...
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)votePollId:(PlanetlinkCoreIdentify *)id choices:(NSArray<PlanetlinkInt *> *)choices completionHandler:(void (^)(NSError * _Nullable))completionHandler __attribute__((swift_name("votePoll(id:choices:completionHandler:)")));
@end
...
- (instancetype)initWithService:(NSString *)service limit:(int32_t)limit remaining:(int32_t)remaining reset:(PlanetlinkKotlinInstant * _Nullable)reset __attribute__((swift_name("init(service:limit:remaining:reset:)"))) __attribute__((objc_designated_initializer));
...
@property (readonly) PlanetlinkKotlinInstant * _Nullable reset __attribute__((swift_name("reset")));
...
@interface PlanetlinkKotlinInstant : PlanetlinkBase <PlanetlinkKotlinComparable>
@property (class, readonly, getter=companion) PlanetlinkKotlinInstantCompanion *companion __attribute__((swift_name("companion")));
- (int32_t)compareToOther:(PlanetlinkKotlinInstant *)other __attribute__((swift_name("compareTo(other:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (PlanetlinkKotlinInstant *)minusDuration:(int64_t)duration __attribute__((swift_name("minus(duration:)")));
- (int64_t)minusOther:(PlanetlinkKotlinInstant *)other __attribute__((swift_name("minus(other:)")));
- (PlanetlinkKotlinInstant *)plusDuration:(int64_t)duration __attribute__((swift_name("plus(duration:)")));
 ...
 * アダプターがサポートする機能の一覧
 */
__attribute__((swift_name("CoreCapabilities")))
@interface PlanetlinkCoreCapabilities : PlanetlinkBase
- (instancetype)initWithSupportedActions:(NSSet<id<PlanetlinkCoreActionType>> *)supportedActions __attribute__((swift_name("init(supportedActions:)"))) __attribute__((objc_designated_initializer));
- (BOOL)isAllSupportedActions:(PlanetlinkKotlinArray<id<PlanetlinkCoreActionType>> *)actions __attribute__((swift_name("isAllSupported(actions:)")));
- (BOOL)isAnySupportedActions:(PlanetlinkKotlinArray<id<PlanetlinkCoreActionType>> *)actions __attribute__((swift_name("isAnySupported(actions:)")));
- (BOOL)isSupportedAction:(id<PlanetlinkCoreActionType>)action __attribute__((swift_name("isSupported(action:)")));
- (NSArray<id<PlanetlinkCoreActionType>> *)supportedOfActions:(PlanetlinkKotlinArray<id<PlanetlinkCoreActionType>> *)actions __attribute__((swift_name("supportedOf(actions:)")));
@property (readonly) NSSet<id<PlanetlinkCoreActionType>> *supportedActions __attribute__((swift_name("supportedActions")));
@end
...
@property PlanetlinkKotlinInstant * _Nullable createAt __attribute__((swift_name("createAt")));
 ...
 */
- (PlanetlinkCoreCommentForm *)linkLink:(PlanetlinkCoreLinkForm * _Nullable)link __attribute__((swift_name("link(link:)")));
...
/** External link card */
@property PlanetlinkCoreLinkForm * _Nullable link __attribute__((swift_name("link")));
 ...
 * 最終更新日時
 */
@property PlanetlinkKotlinInstant * _Nullable lastUpdate __attribute__((swift_name("lastUpdate")));
 ...
 */
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("CoreNotificationActionType")))
@interface PlanetlinkCoreNotificationActionType : PlanetlinkKotlinEnum<PlanetlinkCoreNotificationActionType *>
+ (instancetype)alloc __attribute__((unavailable));
...
@property (class, readonly) PlanetlinkCoreNotificationActionType *mention __attribute__((swift_name("mention")));
@property (class, readonly) PlanetlinkCoreNotificationActionType *quote __attribute__((swift_name("quote")));
@property (class, readonly) PlanetlinkCoreNotificationActionType *follow __attribute__((swift_name("follow")));
@property (class, readonly) PlanetlinkCoreNotificationActionType *followRequest __attribute__((swift_name("followRequest")));
@property (class, readonly) PlanetlinkCoreNotificationActionType *share __attribute__((swift_name("share")));
@property (class, readonly) PlanetlinkCoreNotificationActionType *like __attribute__((swift_name("like")));
@property (class, readonly) PlanetlinkCoreNotificationActionType *reaction __attribute__((swift_name("reaction")));
@property (class, readonly) PlanetlinkCoreNotificationActionType *poll __attribute__((swift_name("poll")));
+ (PlanetlinkKotlinArray<PlanetlinkCoreNotificationActionType *> *)values __attribute__((swift_name("values()")));
@property (class, readonly) NSArray<PlanetlinkCoreNotificationActionType *> *entries __attribute__((swift_name("entries")));
...
@interface PlanetlinkCoreNotification : PlanetlinkCoreIdentify
- (instancetype)initWithService:(PlanetlinkCoreService *)service __attribute__((swift_name("init(service:)"))) __attribute__((objc_designated_initializer));
- (instancetype)initWithService:(PlanetlinkCoreService *)service id:(id)id __attribute__((swift_name("init(service:id:)"))) __attribute__((objc_designated_initializer)) __attribute__((unavailable));
 ...
 */
@property NSString * _Nullable action __attribute__((swift_name("action")));

/** Associated comments  */
@property NSArray<PlanetlinkCoreComment *> * _Nullable comments __attribute__((swift_name("comments")));
 ...
 * ブックマークしたコメントのタイムラインを取得
 */
- (id<PlanetlinkCoreCommentsRequest>)userBookmarkTimeLine __attribute__((swift_name("userBookmarkTimeLine()")));
 ...
 */
__attribute__((swift_name("CoreCommentUpdateStream")))
@protocol PlanetlinkCoreCommentUpdateStream <PlanetlinkCoreStream>
@required
 ...
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)addCommentsComments:(NSArray<PlanetlinkCoreComment *> *)comments completionHandler:(void (^)(NSError * _Nullable))completionHandler __attribute__((swift_name("addComments(comments:completionHandler:)")));
 ...
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)removeCommentsComments:(NSArray<PlanetlinkCoreComment *> *)comments completionHandler:(void (^)(NSError * _Nullable))completionHandler __attribute__((swift_name("removeComments(comments:completionHandler:)")));
@end
 ...
 */
__attribute__((swift_name("CoreSpace")))
@interface PlanetlinkCoreSpace : PlanetlinkCoreIdentify
- (instancetype)initWithService:(PlanetlinkCoreService *)service __attribute__((swift_name("init(service:)"))) __attribute__((objc_designated_initializer));
- (instancetype)initWithService:(PlanetlinkCoreService *)service id:(id)id __attribute__((swift_name("init(service:id:)"))) __attribute__((objc_designated_initializer)) __attribute__((unavailable));
@property PlanetlinkKotlinInstant * _Nullable createAt __attribute__((swift_name("createAt")));
@property (setter=setDescription:) NSString * _Nullable description_ __attribute__((swift_name("description_")));
 ...
 */
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("CoreProfileForm")))
@interface PlanetlinkCoreProfileForm : PlanetlinkBase
...
/** Avatar image bytes */
@property PlanetlinkKotlinByteArray * _Nullable avatar __attribute__((swift_name("avatar")));
...
@property PlanetlinkKotlinByteArray * _Nullable banner __attribute__((swift_name("banner")));

/** Banner / header image file name */
@property NSString * _Nullable bannerName __attribute__((swift_name("bannerName")));
...
@interface PlanetlinkKotlinInstantCompanion : PlanetlinkBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) PlanetlinkKotlinInstantCompanion *shared __attribute__((swift_name("shared")));
- (PlanetlinkKotlinInstant *)fromEpochMillisecondsEpochMilliseconds:(int64_t)epochMilliseconds __attribute__((swift_name("fromEpochMilliseconds(epochMilliseconds:)")));
- (PlanetlinkKotlinInstant *)fromEpochSecondsEpochSeconds:(int64_t)epochSeconds nanosecondAdjustment:(int32_t)nanosecondAdjustment __attribute__((swift_name("fromEpochSeconds(epochSeconds:nanosecondAdjustment:)")));
- (PlanetlinkKotlinInstant *)fromEpochSecondsEpochSeconds:(int64_t)epochSeconds nanosecondAdjustment_:(int64_t)nanosecondAdjustment __attribute__((swift_name("fromEpochSeconds(epochSeconds:nanosecondAdjustment_:)")));
- (PlanetlinkKotlinInstant *)now __attribute__((swift_name("now()"))) __attribute__((unavailable("Use Clock.System.now() instead")));
- (PlanetlinkKotlinInstant *)parseInput:(id)input __attribute__((swift_name("parse(input:)")));
- (PlanetlinkKotlinInstant * _Nullable)parseOrNullInput:(id)input __attribute__((swift_name("parseOrNull(input:)")));
@property (readonly) PlanetlinkKotlinInstant *DISTANT_FUTURE __attribute__((swift_name("DISTANT_FUTURE")));
@property (readonly) PlanetlinkKotlinInstant *DISTANT_PAST __attribute__((swift_name("DISTANT_PAST")));
@end
...
@property PlanetlinkInt * _Nullable height __attribute__((swift_name("height")));
...
@property PlanetlinkInt * _Nullable width __attribute__((swift_name("width")));
@end
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("CoreLinkForm")))
@interface PlanetlinkCoreLinkForm : PlanetlinkBase
- (instancetype)initWithUri:(NSString *)uri title:(NSString *)title description:(NSString *)description __attribute__((swift_name("init(uri:title:description:)"))) __attribute__((objc_designated_initializer));

/** Copy this object */
- (PlanetlinkCoreLinkForm *)doCopy __attribute__((swift_name("doCopy()")));
...
@property PlanetlinkCoreMediaForm * _Nullable thumbnail __attribute__((swift_name("thumbnail")));
 ...
 */
- (BOOL)canUseCommentsUpdateStream __attribute__((swift_name("canUseCommentsUpdateStream()")));
 ...
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)setCommentsStreamCallback:(id<PlanetlinkCoreEventCallback>)callback completionHandler:(void (^)(id<PlanetlinkCoreStream> _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("setCommentsStream(callback:completionHandler:)")));
 ...
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)setCommentsUpdateStreamComments:(NSArray<PlanetlinkCoreComment *> *)comments callback:(id<PlanetlinkCoreEventCallback>)callback completionHandler:(void (^)(id<PlanetlinkCoreCommentUpdateStream> _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("setCommentsUpdateStream(comments:callback:completionHandler:)")));
@end
...
@property (class, readonly) PlanetlinkCoreMediaType *audio __attribute__((swift_name("audio")));
