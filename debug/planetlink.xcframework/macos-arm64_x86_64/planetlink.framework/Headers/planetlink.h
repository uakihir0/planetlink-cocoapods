...
- (BOOL)isMastodon:(PlanetlinkCoreService *)receiver __attribute__((swift_name("isMastodon(_:)")));
- (BOOL)isMisskey:(PlanetlinkCoreService *)receiver __attribute__((swift_name("isMisskey(_:)")));
- (BOOL)isPixelFed:(PlanetlinkCoreService *)receiver __attribute__((swift_name("isPixelFed(_:)")));
- (BOOL)isPleroma:(PlanetlinkCoreService *)receiver __attribute__((swift_name("isPleroma(_:)")));
...
- (instancetype)initWithService:(NSString *)service limit:(int32_t)limit remaining:(int32_t)remaining reset:(PlanetlinkKotlinx_datetimeInstant *)reset __attribute__((swift_name("init(service:limit:remaining:reset:)"))) __attribute__((objc_designated_initializer));
...
@property (readonly) PlanetlinkKotlinx_datetimeInstant *reset __attribute__((swift_name("reset")));
...
@property NSArray<PlanetlinkCoreMedia *> * _Nullable medias __attribute__((swift_name("medias")));
...
@property (readonly) NSArray<PlanetlinkCoreReaction *> * _Nullable reactions __attribute__((swift_name("reactions")));
...
@property NSString * _Nullable name __attribute__((swift_name("name")));
@property (getter=public, setter=setPublic:) PlanetlinkBoolean * _Nullable public_ __attribute__((swift_name("public_")));
@end
...
@property NSMutableArray<NSString *> * _Nullable shortCodes __attribute__((swift_name("shortCodes")));
@end
...
- (void)open __attribute__((swift_name("open()")));
...
- (PlanetlinkKotlinx_datetimeInstant *)parseIsoString:(NSString *)isoString __attribute__((swift_name("parse(isoString:)")));
...
- (instancetype)init __attribute__((swift_name("init()"))) __attribute__((objc_designated_initializer));
+ (instancetype)new __attribute__((availability(swift, unavailable, message="use object initializers instead")));
@property PlanetlinkLong * _Nullable count __attribute__((swift_name("count")));
@property NSString * _Nullable emoji __attribute__((swift_name("emoji")));
...
- (PlanetlinkCorePollForm *)expiresInExpiresIn:(int64_t)expiresIn __attribute__((swift_name("expiresIn(expiresIn:)")));
- (PlanetlinkCorePollForm *)multipleMultiple:(BOOL)multiple __attribute__((swift_name("multiple(multiple:)")));
@property int64_t expiresIn __attribute__((swift_name("expiresIn")));
